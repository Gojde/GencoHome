...
var slideImg = document.querySelectorAll('.slider img');
...
var activeClass = document.querySelector('.activeX'); // Buttons

var prevBtn = document.querySelector('.arrowOne');
var nextBtn = document.querySelector('.arrowTwo'); // Counter

var counter = 1;
var size = rightSide.clientWidth; // Media query
...
require("./js/homePage");
},{"./js/homePage":"js/homePage.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
